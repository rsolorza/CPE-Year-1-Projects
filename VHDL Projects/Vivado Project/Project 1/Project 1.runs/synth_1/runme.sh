...
HD_PWD='C:/Users/rhino/Desktop/Vivado Project/Project 1/Project 1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Temp_Conversion_Project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Temp_Conversion_Project.tcl
