...
HD_PWD='C:/Users/rhino/Desktop/Vivado Project/Project 1/Project 1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Temp_Conversion_Project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Temp_Conversion_Project.tcl -notrace
