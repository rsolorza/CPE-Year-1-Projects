...
HD_PWD='C:/Users/rhino/Desktop/Piano_Project/Piano_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Piano_Final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Piano_Final.tcl
