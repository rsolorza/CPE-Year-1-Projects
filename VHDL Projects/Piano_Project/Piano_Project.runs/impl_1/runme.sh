...
HD_PWD='C:/Users/rhino/Desktop/Piano_Project/Piano_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Piano_Final.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Piano_Final.tcl -notrace
