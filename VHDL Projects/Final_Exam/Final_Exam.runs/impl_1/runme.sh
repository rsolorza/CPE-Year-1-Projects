...
HD_PWD='C:/Users/rhino/Desktop/Final_Exam/Final_Exam.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Driverless_Final.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Driverless_Final.tcl -notrace
