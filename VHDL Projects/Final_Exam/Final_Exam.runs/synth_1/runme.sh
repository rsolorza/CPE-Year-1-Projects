...
HD_PWD='C:/Users/rhino/Desktop/Final_Exam/Final_Exam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driverless_Final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driverless_Final.tcl
